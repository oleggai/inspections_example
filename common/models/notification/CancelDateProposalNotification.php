...
/**
 * Class RemoveSubjectFromCpNotification Повідомлення ініціатору пропозиції про відхилення запропонованої дати перевірки
 * @package common\models\notification
 */
class CancelDateProposalNotification extends Notification implements NotifyInterface
{
    const TYPE = 'cancel_date_proposal';
    ...
    {
        return "Повідомлення для адміністратора органу-ініціатора про відхилення запропонованої дати перевірки";
    }
    ...
    {
        return "Відхилення запропонованої дати перевірки";
    }
    ...
    {
        $format = "Ініційована Вами зміна дати перевірки %s була відхилена";
